...
- **Repository:** zestysoft/sensus_analytics_integration

**Key directories:**

- `custom_components/sensus_analytics/` - Main integration code
...
- Integration logs: `custom_components.sensus_analytics: debug` in `config/configuration.yaml`
...
- Use the domain `sensus_analytics` for all DOMAIN references
- Prefix all integration-specific classes with `SensusAnalytics`
- Use "Sensus Analytics Integration" as the display title
