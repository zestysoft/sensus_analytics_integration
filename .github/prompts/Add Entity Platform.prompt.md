...
**Directory:** `custom_components/sensus_analytics/[platform]/`
...
```python
"""[Platform] platform for Sensus Analytics Integration."""
...
from .entity import SensusAnalyticsEntity
from .[entity_file] import SensusAnalytics[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: SensusAnalyticsDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            SensusAnalytics[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Sensus Analytics Integration."""
...
class SensusAnalytics[EntityName](
    SensusAnalyticsEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/sensus_analytics/manifest.json`:
...
- [ ] Entity class inherits from both `SensusAnalyticsEntity` and platform class
...
- **Base entity:** `SensusAnalyticsEntity` in `entity/base.py`
- **Coordinator:** `SensusAnalyticsDataUpdateCoordinator`
