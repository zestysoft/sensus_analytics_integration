...
- Create new sensor file in `custom_components/sensus_analytics/sensor/`
- Inherit from `SensusAnalyticsEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Sensus Analytics Integration."""
...
class SensusAnalytics[SensorName]Sensor(
