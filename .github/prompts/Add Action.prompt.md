...
**File:** `custom_components/sensus_analytics/services.yaml`
...
Create `custom_components/sensus_analytics/service_actions/[action_name].py`:

```python
"""[Action name] service action for Sensus Analytics Integration."""
...
**File:** `custom_components/sensus_analytics/__init__.py`
...
**File:** `custom_components/sensus_analytics/const.py`
...
3. Find service action: `sensus_analytics.[action_name]`
...
- **Service actions directory:** `custom_components/sensus_analytics/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/sensus_analytics/services.yaml` (legacy filename)
- **Icons:** `custom_components/sensus_analytics/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/sensus_analytics/translations/*.json` under `services` key (legacy)
